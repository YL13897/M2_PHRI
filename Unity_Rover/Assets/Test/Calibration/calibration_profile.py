...
class CalibrationProfile:
    ...
    fit_discard_sec: float = 0.5
    fit_window_sec: float = 0.5
...
def save_profile(profile, directory, base_id):
    ...
    data = {
        ...
        "fit_discard_sec": profile.fit_discard_sec,
        "fit_window_sec": profile.fit_window_sec,
